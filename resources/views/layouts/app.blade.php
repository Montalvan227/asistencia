...
<body class="font-sans antialiased">
    <div x-data="{
        ...
        <div :class="menuOpen ? 'block' : 'hidden'" @click="menuOpen = false"
            class="fixed z-20 inset-0 lg:hidden"></div>
        <!-- end::Black overlay -->
                                            ...
                                            <div class="bg-white rounded">
                                                    ...
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="text-sm ml-3">
                                                            <p class="text-gray-600 font-bold capitalize"
                                                                :class="linkHover ? 'text-primary' : ''">Perfil</p>
                                                        </div>
                                                    </div>
                                                </a>
                                                <!-- end::Submenu link -->
                                                ...
                                                <a x-data="{ linkHover: false }" href="{{ route('profile.show') }}"
                                                    ...
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="text-sm ml-3">
                                                            <p class="text-gray-600 font-bold capitalize"
                                                                :class="linkHover ? 'text-primary' : ''">Configuración</p>
                                                        </div>
                                                    </div>
                                                </a>
                                                <!-- end::Submenu link -->
                                                ...
                                                <form method="POST" action="{{ route('logout') }}"
                                                    x-data="{ linkHover: false }"class="flex items-center justify-between py-2 px-3"
                                                    @mouseover="linkHover = true" @mouseleave="linkHover = false">
                                                    @csrf
                                                    <div class="flex items-center">
                                                            ...
                                                            <div class="flex items-center">
                                                                ...
                                                                <div class="text-sm ml-3">
                                                                    <p class="text-gray-200 font-bold capitalize"
                                                                        :class="linkHover ? 'text-primary' : ''">Perfil
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </a>
